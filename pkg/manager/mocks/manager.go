...
func (_m *Manager) DeployInstance(_a0 context.Context, _a1 *chart.ReleaseInstance) error {
	...
	if len(ret) == 0 {
		panic("no return value specified for DeployInstance")
	}
...
func (_m *Manager) GenerateNATSResources(_a0 *chart.ReleaseInstance, _a1 ...manager.Option) (*chart.ManifestResources, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for GenerateNATSResources")
	}
...
func (_m *Manager) GenerateOverrides(_a0 *nmapiv1alpha1.NATSSpec, _a1 bool, _a2 bool) map[string]interface{} {
	...
	if rf, ok := ret.Get(0).(func(*nmapiv1alpha1.NATSSpec, bool, bool) map[string]interface{}); ok {
		r0 = rf(_a0, _a1, _a2)
	} else {
		if ret.Get(0) != nil {
...
func (_c *Manager_GenerateOverrides_Call) Run(run func(_a0 *nmapiv1alpha1.NATSSpec, _a1 bool, _a2 bool)) *Manager_GenerateOverrides_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(*nmapiv1alpha1.NATSSpec), args[1].(bool), args[2].(bool))
	})
	return _c
}
...
func (_c *Manager_GenerateOverrides_Call) RunAndReturn(run func(*nmapiv1alpha1.NATSSpec, bool, bool) map[string]interface{}) *Manager_GenerateOverrides_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *Manager) IsNATSStatefulSetReady(_a0 context.Context, _a1 *chart.ReleaseInstance) (bool, error) {
	...
	if len(ret) == 0 {
		panic("no return value specified for IsNATSStatefulSetReady")
	}
