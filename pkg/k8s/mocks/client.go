...
func (_m *Client) GetConfigMap(_a0 context.Context, _a1 string, _a2 string) (*corev1.ConfigMap, error) {
...
//   - _a1 string
//   - _a2 string
func (_e *Client_Expecter) GetConfigMap(_a0 interface{}, _a1 interface{}, _a2 interface{}) *Client_GetConfigMap_Call {
	return &Client_GetConfigMap_Call{Call: _e.mock.On("GetConfigMap", _a0, _a1, _a2)}
}

func (_c *Client_GetConfigMap_Call) Run(run func(_a0 context.Context, _a1 string, _a2 string)) *Client_GetConfigMap_Call {
	_c.Call.Run(func(args mock.Arguments) {
