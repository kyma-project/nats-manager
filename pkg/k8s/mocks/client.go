...
func (_m *Client) GetCRD(_a0 context.Context, _a1 string) (*kapiextv1.CustomResourceDefinition, error) {
	ret := _m.Called(_a0, _a1)
	...
	var r0 *kapiextv1.CustomResourceDefinition
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string) (*kapiextv1.CustomResourceDefinition, error)); ok {
		return rf(_a0, _a1)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string) *kapiextv1.CustomResourceDefinition); ok {
		r0 = rf(_a0, _a1)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*kapiextv1.CustomResourceDefinition)
		}
	}
...
func (_c *Client_GetCRD_Call) Return(_a0 *kapiextv1.CustomResourceDefinition, _a1 error) *Client_GetCRD_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Client_GetCRD_Call) RunAndReturn(run func(context.Context, string) (*kapiextv1.CustomResourceDefinition, error)) *Client_GetCRD_Call {
	_c.Call.Return(run)
	return _c
}
