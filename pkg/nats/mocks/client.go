...
func (_m *Client) GetStreams() ([]*natsgo.StreamInfo, error) {
	ret := _m.Called()
	...
	var r1 error
	if rf, ok := ret.Get(0).(func() ([]*natsgo.StreamInfo, error)); ok {
		return rf()
	}
	if rf, ok := ret.Get(0).(func() []*natsgo.StreamInfo); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
...
func (_c *Client_GetStreams_Call) Return(_a0 []*natsgo.StreamInfo, _a1 error) *Client_GetStreams_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Client_GetStreams_Call) RunAndReturn(run func() ([]*natsgo.StreamInfo, error)) *Client_GetStreams_Call {
	_c.Call.Return(run)
	return _c
}
