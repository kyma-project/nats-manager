...
NATS is an infrastructure that enables the exchange of data in the form of messages. One features of NATS is JetStream. JetStream is a distributed persistence system that provides more functionalities and higher qualities of service on top of `Core NATS`.
...
3. The Controller reacts to changes in the NATS CR to adapt the resources mentioned above to the desired state.
