...
1. Follow the diagnostic steps as mentioned in [Eventing Troubleshooting](https://github.com/kyma-project/eventing-manager/docs/user/troubleshooting/evnt-01-eventing-troubleshooting.md).
