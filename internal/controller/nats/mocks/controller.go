...
func (_m *Controller) Watch(src source.Source) error {
	ret := _m.Called(src)
...
//   - src source.Source
func (_e *Controller_Expecter) Watch(src interface{}) *Controller_Watch_Call {
	return &Controller_Watch_Call{Call: _e.mock.On("Watch", src)}
}

func (_c *Controller_Watch_Call) Run(run func(src source.Source)) *Controller_Watch_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *Controller_Watch_Call) RunAndReturn(run func(source.Source) error) *Controller_Watch_Call {
	_c.Call.Return(run)
	return _c
}
